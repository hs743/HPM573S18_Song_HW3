class Node:
    ...
    def __init__(self, name, cost, utility):
        ...
        :param utility: Health utility of this node
...
class ChanceNode(Node):
    ...
    def get_expected_utility(self):
        ...
        exp_utility = self.utility # expected utility initialized with the health utility
...
print("Cost:", D1.get_expected_costs())

# print the expect utility of C1

print("The health utility:",  D1.get_expected_utility())